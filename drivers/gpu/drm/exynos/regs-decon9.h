...
#define GLOBAL_CON_TEN_BPC_MODE_F		(1 << 10)
#define GLOBAL_CON_TEN_BPC_MODE_MASK		(1 << 10)
...
#define HW_TRIG_SEL_MASK			(0x7 << 8)
#define HW_TRIG_SEL_FROM_NONE			(0x0 << 8)
#define HW_TRIG_SEL_FROM_DDI0			(0x1 << 8)
#define HW_TRIG_SEL_FROM_DDI1			(0x2 << 8)
#define HW_TRIG_SEL_FROM_DDI2			(0x4 << 8)
#define HW_TRIG_MASK_DECON			(1 << 4)
#define SW_TRIG_DET_EN				(1 << 1)
#define HW_TRIG_EN				(1 << 0)
#define SW_TRIG_EN				(1 << 0)
...
#define SHD_REG_UP_REQ_DQE_CGC			(1 << 29)
...
#define WIN_FUNC_CON_0(_id)			(WIN_OFFSET(_id) + 0x0004)
...
#define WIN_FUNC_CON_1(_id)			(WIN_OFFSET(_id) + 0x0008)
...
#define WIN_START_POSITION(_id)			(WIN_OFFSET(_id) + 0x000c)
#define WIN_STRPTR_Y_F(_v)			(((_v) & 0x3fff) << 16)
#define WIN_STRPTR_X_F(_v)			(((_v) & 0x3fff) << 0)

#define WIN_END_POSITION(_id)			(WIN_OFFSET(_id) + 0x0010)
#define WIN_ENDPTR_Y_F(_v)			(((_v) & 0x3fff) << 16)
#define WIN_ENDPTR_X_F(_v)			(((_v) & 0x3fff) << 0)

#define WIN_COLORMAP_0(_id)			(WIN_OFFSET(_id) + 0x0014)
...
#define WIN_COLORMAP_1(_id)			(WIN_OFFSET(_id) + 0x0018)
...
#define WIN_START_TIME_CON(_id)			(WIN_OFFSET(_id) + 0x001c)
