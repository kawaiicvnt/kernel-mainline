...
#include <dt-bindings/interconnect/mediatek,mt6789.h>
...
static struct mtk_icc_node *mt6789_emi_icc_nodes[] = {
...
static struct mtk_icc_desc mt6789_emi_icc = {
	.nodes = mt6789_emi_icc_nodes,
	.num_nodes = ARRAY_SIZE(mt6789_emi_icc_nodes),
};

static const struct of_device_id mtk_mt6789_emi_icc_of_match[] = {
	{ .compatible = "mediatek,mt6789-emi", .data = &mt6789_emi_icc },
	{ /* sentinel */ },
};
MODULE_DEVICE_TABLE(of, mtk_mt6789_emi_icc_of_match);

static struct platform_driver mtk_emi_icc_mt6789_driver = {
	.driver = {
		.name = "emi-icc-mt6789",
		.of_match_table = mtk_mt6789_emi_icc_of_match,
...
module_platform_driver(mtk_emi_icc_mt6789_driver);

MODULE_AUTHOR("Arseniy Velikanov <me@adomerle.pw>");
MODULE_DESCRIPTION("MediaTek MT6789 EMI ICC driver");
MODULE_LICENSE("GPL");
